...
extern(C) nothrow @nogc {
    ...
    // TODO have ref generated by vkdgen.py
    alias PFN_vkCmdSetBlendConstants = void function (
        VkCommandBuffer commandBuffer,
        const ref float[4]  blendConstants,
    );
...
final class VkInstanceCmds {
    ...
    version(Windows) {
        ...
        VkResult CreateWin32SurfaceKHR (VkInstance instance, const(VkWin32SurfaceCreateInfoKHR)* pCreateInfo, const(VkAllocationCallbacks)* pAllocator, VkSurfaceKHR* pSurface) {
            assert(_CreateWin32SurfaceKHR !is null, "vkCreateWin32SurfaceKHR was not loaded. Requested by VK_KHR_win32_surface");
        ...
        VkBool32 GetPhysicalDeviceWin32PresentationSupportKHR (VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex) {
            assert(_GetPhysicalDeviceWin32PresentationSupportKHR !is null, "vkGetPhysicalDeviceWin32PresentationSupportKHR was not loaded. Requested by VK_KHR_win32_surface");
...
final class VkDeviceCmds {
    ...
    /// ditto
    void CmdSetBlendConstants (VkCommandBuffer commandBuffer, const ref float[4] blendConstants) {
